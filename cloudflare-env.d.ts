/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a8f71bbd80db4e4fd80725f4f9789ab0)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		cloudfare_Origin_CA_Key: string;
