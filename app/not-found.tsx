  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', padding: '32px 40px', border: '1px solid var(--border)', maxWidth: 480 }}>
        ...
        <div style={{ fontFamily: 'IBM Plex Mono', fontSize: 11, color: 'var(--accent-gold)', letterSpacing: '2px', marginBottom: 12 }}>
          ◆ SIGNAL NOT FOUND
        </div>
        <div style={{ fontFamily: 'Bebas Neue', fontSize: 64, color: 'var(--text-primary)', lineHeight: 1, letterSpacing: '2px', marginBottom: 8 }}>
          404
        </div>
        <p style={{ fontFamily: 'IBM Plex Mono', fontSize: 11, color: 'var(--text-secondary)', lineHeight: 1.7, margin: '0 0 24px 0' }}>
