  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <Card>
          <p className="font-mono text-[11px] uppercase mb-1" style={{ color: 'var(--text-muted)' }}>Conflict Day</p>
          <p className="text-2xl font-mono" style={{ color: 'var(--accent-red)' }}>{conflictDay}</p>
        </Card>
        <Card>
          <p className="font-mono text-[11px] uppercase mb-1" style={{ color: 'var(--text-muted)' }}>Users</p>
        ...
        <Card>
          <p className="font-mono text-[11px] uppercase mb-1" style={{ color: 'var(--text-muted)' }}>MRR</p>
        ...
        <Card>
          <p className="font-mono text-[11px] uppercase mb-1" style={{ color: 'var(--text-muted)' }}>Pipeline</p>
          ...
          {latestRun?.duration_seconds != null && (
            <p className="font-mono text-[11px]" style={{ color: 'var(--text-muted)' }}>{latestRun.duration_seconds}s</p>
          )}
        </Card>
        <Card>
          <p className="font-mono text-[11px] uppercase mb-1" style={{ color: 'var(--text-muted)' }}>Disputes</p>
      ...
      <Card>
        ...
        <div className="flex gap-4 items-end">
          <div className="flex-1">
            <p className="font-mono text-[11px]" style={{ color: 'var(--text-muted)' }}>A</p>
          ...
          <div className="flex-1">
            <p className="font-mono text-[11px]" style={{ color: 'var(--text-muted)' }}>B</p>
            <div className="h-8 border rounded overflow-hidden" style={{ borderColor: 'var(--border)' }}>
              <div className="h-full bg-blue-600/80" style={{ width: `${scB}%` }} />
            </div>
          </div>
          <div className="flex-1">
            <p className="font-mono text-[11px]" style={{ color: 'var(--text-muted)' }}>C</p>
            <div className="h-8 border rounded overflow-hidden" style={{ borderColor: 'var(--border)' }}>
